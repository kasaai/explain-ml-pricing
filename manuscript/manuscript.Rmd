...
@anderson_2005 to the syllabus. Beginning in 2016, the CAS introduced @goldburd_2016
...
Outside of telematics, @yang_2018 use a gradient tree-boosting approach to 
...
may also be relevant to other contexts, such as claim-level reserving / analytics
...
with the intended purpose." [@asop_56] All of these efforts may be hampered if
...
This poses a challenge that @millerExplainableAI2017 call "inmates running
...
the methods described in [@goldburd_2016], Chapter 7, which focus on global
...
Here, by *permuting* a variable, we mean that we randomly rearrange the values 
...
conditional, rather than marginal, distributions [@apley2016visualizing].
...
Shapley values were also used in @mango_1998, which has appeared on the CAS syllabus
