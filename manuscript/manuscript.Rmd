...
affiliation:
  - num: a
    address: |
      Kasa AI,
      3040 78th Ave SE #1271,
      Mercer Island, WA 98040, USA
  - num: b
    address: |
      Taylor & Mulder,
      10508 Rivers Bend Lane,
...
```{r tree-plot1, echo = FALSE, fig.cap="A simple decision tree for loss cost prediction.", out.width="70%", fig.align='center'}
...
```{r tree-plot2, echo = FALSE, fig.cap="A more complex decision tree for loss cost prediction.", out.width="90%", fig.align='center'}
...
```{r fi, out.width='60%', fig.align = "center", fig.cap="Permutation feature importances for ML model.", echo = FALSE}
...
```{r pdp, out.width='60%', fig.align = "center", fig.cap="Partial dependence plot for ML model.", echo = FALSE}
...
```{r breakdown, out.width='80%', fig.align = "center", fig.cap="Variable contribution plot for ML model.", echo = FALSE}
